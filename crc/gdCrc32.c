...
{
    uint32_t crc = 0;
    //uint8_t pData[6] = {0x14,0x08,0x00,0x03,0x01,0x32};
    uint8_t pData[112] = {0x14,0x72,0x00,0x03,0x00,0x80,0x00,0x00,0xcc,0x01,0x05,0x01,0xfe,0x00,0xff,0x00,0x00,0x00,0x00,0xb0,0xd7,0x42,0x10,0xe6,0x07,0x0c,0x02,0x10,
                          ...
                          0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x06,0x05,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7e,0x71};
	crc = CRC32Software(pData, 112);
 
	printf("The crc test = %08x %d\n", crc, sizeof(pData));
	return 0;
}
